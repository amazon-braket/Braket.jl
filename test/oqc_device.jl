...
@testset "OQC device schema" begin
    @testset "Device capabilities" begin
        ...
        @testset for format in [openqasm]
            @test Braket.parse_raw_schema(format()) isa Braket.OqcDeviceCapabilities
        end
    end
    @testset "Device parameters" begin
        ...
        """
        @test Braket.parse_raw_schema(ir_gen()) isa Braket.OqcDeviceParameters
    end
    @testset "Provider properties" begin
        ...
        """
        @test Braket.parse_raw_schema(ir_gen()) isa Braket.OqcProviderProperties
    end
end
