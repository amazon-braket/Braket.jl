...
Base.acos(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(acos(x.value))
Base.asin(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(asin(x.value))
Base.atan(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(atan(x.value))
...
Base.cos(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(cos(x.value))
Base.sin(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(sin(x.value))
Base.tan(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(tan(x.value))
...
Base.sqrt(x::OpenQASM3.IntegerLiteral) = OpenQASM3.FloatLiteral(sqrt(x.value))
Base.exp(x::OpenQASM3.IntegerLiteral)  = OpenQASM3.FloatLiteral(exp(x.value))
Base.log(x::OpenQASM3.IntegerLiteral)  = OpenQASM3.FloatLiteral(log(x.value))
Base.ceil(x::OpenQASM3.FloatLiteral)   = OpenQASM3.IntegerLiteral(Int(ceil(x.value)))
Base.floor(x::OpenQASM3.FloatLiteral)  = OpenQASM3.IntegerLiteral(Int(floor(x.value)))
Base.ceil(x::OpenQASM3.IntegerLiteral)   = OpenQASM3.IntegerLiteral(Int(ceil(x.value)))
Base.floor(x::OpenQASM3.IntegerLiteral)  = OpenQASM3.IntegerLiteral(Int(floor(x.value)))
